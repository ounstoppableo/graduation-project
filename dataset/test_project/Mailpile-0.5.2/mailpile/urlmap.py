...
class UrlMap:
    ...
    def _command(self, name,
        ...
        return command(self.session, name, args, data=data, _async=_async)
    ...
    def _map_api_command(self, method, path_parts,
                         query_data, post_data, fmt='html', _async=False):
